...
st.markdown("# PrepWise")
st.caption("Smart data preparation tool for cleaning, transformation, and analysis")

st.markdown("### Clean, transform, and prepare your data — without the mess.")
# ------------------ STYLE ------------------
st.markdown("""
<style>
...
if df is None:
    ...
    ">
        ...
        <div style="margin-top:10px;">
            Rows: <b>{rows}</b><br>
            Columns: <b>{cols}</b><br>
            Missing values: <b>{missing}</b><br>
            Duplicate rows: <b>{duplicates}</b>
        </div>
    </div>
    """, unsafe_allow_html=True)
    st.caption("Dataset is ready for cleaning and transformation.")